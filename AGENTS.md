<!-- Источник истины: CLAUDE.md. Файл синхронизирован для агентов, читающих AGENTS.md (например, GitHub Copilot, кодинговые агенты на базе SDK). При изменении правил — править CLAUDE.md и копировать сюда же и в gemini.md. -->

# КировБелМаш — AGENTS.md

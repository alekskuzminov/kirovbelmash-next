...
### Industrial Equipment Page (B2B Manufacturing)

For pages about specific machines, production lines, or industrial equipment. Buyer is a technical specialist or plant owner with a long decision cycle.

```
1. Hero (equipment name + key outcome: production capacity, output material)
2. What it produces / for what raw material (quick self-identification)
3. Key specs block (table: capacity, power, dimensions, moisture %)
4. How it works (3-4 steps: input → process → output)
5. Benefits for the buyer (ROI, payback period, operating costs)
6. Modifications / configurations (if applicable)
7. Completed projects with this equipment (photos, client, metrics)
8. Certifications / quality marks
9. CTA: Request a quote / Download technical catalogue
10. FAQ (installation, service, raw material requirements)
```

Key differences from SaaS pages:
- **Specs come before benefits** — technical buyers need numbers first
- **Raw material compatibility** — always specify what inputs work
- **Payback period** — the #1 objection in industrial B2B
- **Geography of completed projects** — builds trust for regional buyers
- **Service and spare parts** — mention availability, reduces perceived risk

Addresses B2B industrial buyer concerns: technical fit, ROI, reliability, after-sales support.

...
For a more complete list of AI writing tells, check the `seo-audit` skill's `references/ai-writing-detection.md` if that skill is available in your project.

...
export const equipmentCategoriesConfig = [
  ...
  },
  {
    ...
    seoTitle: 'Станок для брикетов из опилок — купить от производителя',
    seoDescription: 'Станки для производства топливных брикетов из опилок: шнековый пресс ПБМ-2 (Pini Kay), автомат резки. Цена от производителя, доставка по России.'
  },
  {
    name: 'Станки для производства пеллет',
    slug: 'oborudovanie-dlja-proizvodstva-granul',
    seoTitle: 'Станок для производства пеллет из опилок — купить от производителя',
    seoDescription: 'Станки для производства топливных пеллет из опилок: гранулятор ОГМ-1,5, колонна охлаждения гранул. Цена от производителя, доставка по России.'
  },
  {

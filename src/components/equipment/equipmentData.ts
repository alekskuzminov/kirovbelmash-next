...
export const equipmentCategoriesConfig = [
  ...
  {
    name: 'Станок для изготовления топливных брикетов из опилок',
    slug: 'briketirujushhee-oborudovanie',
    seoTitle: 'Станок для производства топливных брикетов из опилок',
    seoDescription: 'Станок для изготовления топливных брикетов из опилок: шнековый пресс ПБМ-2 (Pini Kay), автомат резки. Купить станок для производства брикетов из опилок — цена от производителя, доставка по России.'
  },
  {

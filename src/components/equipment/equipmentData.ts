...
export const equipmentItems: EquipmentItem[] = [
  ...
  // Пневмотранспортное оборудование
  {
    ...
    description:
      ...
      'Циклон УЦ-2500 убирает стружку, опилки и сухую пыль из воздуха цеха: 11800–15400 м³/ч, корпус Ø 2500 мм, шлюзовой затвор, смотровые люки. От производителя, доставка по РФ.',
    image:
  ...
  },
  {
    ...
    description:
      ...
      'Циклон-осадитель УЦ-1600 для очистки воздуха от опилок и стружки: 8700–11600 м³/ч, компактный корпус Ø 1600 мм, шлюзовой затвор. От производителя, доставка по РФ.',
    image:

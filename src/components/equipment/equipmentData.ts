...
export const equipmentCategoriesConfig = [
  ...
  },
  {
    ...
    seoTitle: 'Станки для производства брикетов',
    seoDescription: 'Станки для производства брикетов: прессы, автоматы резки и оборудование для стабильного выпуска качественной брикетной продукции.'
  },
  {
    name: 'Станки для производства пеллет',
    slug: 'oborudovanie-dlja-proizvodstva-granul',
    seoTitle: 'Станки для производства пеллет',
    seoDescription: 'Станки для производства пеллет: грануляторы, колонны охлаждения и оборудование для выпуска прочных и качественных гранул.'
  },
  {

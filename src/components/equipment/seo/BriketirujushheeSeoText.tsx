            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
                        Станки для изготовления топливных брикетов из опилок
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                            В каталоге представлены два брикетных станка, которые закрывают полный
                            цикл формовки: шнековый пресс для прессовки опилок в брикеты и
                            автомат резки для нарезки готовых брикетов Pini&nbsp;Kay на мерные
                            отрезки. Оба станка производим сами — на заводе в Кировской области.
                        </p>
                        ...
                        <div className="bg-red-50 rounded-xl py-6 px-6 sm:px-8 border border-red-100 relative">
                            ...
                            <p className="text-base sm:text-lg text-gray-800 italic font-medium leading-relaxed pl-4">
                                Станок для прессовки опилок в брикеты окупается быстрее, чем
                        ...
                        <div>
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                                ...
                                Что входит в комплект станков
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                {[
                                    'Шнековый пресс — формирует брикеты Pini Kay под давлением и нагревом',
                                    'Автомат резки — нарезает непрерывный брикет на мерные отрезки',
                                    'Совместная производительность — до 1000 кг/ч',
                                    'Работа без связующих — только давление и температура 250–300 °C',
                                    'Сырьё: опилки, стружка, мебельная пыль фракции 1–5 мм',
                                    'Влажность сырья перед прессованием — не выше 12%',
                                ].map((item) => (
                        ...
                        <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                            ...
                            Поставляем как отдельные станки, так и полный комплект с
                        ...
                        <div className="border border-gray-200 rounded-xl p-5 sm:p-6 bg-gray-50">
                            ...
                            <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">
                                Цена зависит от комплектации: один брикетный станок, пресс + автомат
                                резки или полная линия с сушкой и дроблением. Поставляем по всей
                                России. Каждый брикетный станок комплектуется договором, паспортом
                                оборудования и гарантией 36 месяцев. Срок изготовления — 6–8 недель.
                            </p>
                            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                                Точную стоимость станков для изготовления топливных брикетов из

    ...
    briquetting: [
        {
            ...
            description: 'Для переработки опилок, стружки и щепы в топливные брикеты. Цена от 9,4 млн ₽. Проектирование, изготовление, поставка и запуск под ключ.',
        ...
        },
        {
            ...
            description: 'Производительное решение для выпуска топливных брикетов из древесного сырья. Цена от 11,7 млн ₽. Поставка, запуск и ввод линии в работу под ключ.',
        ...
        },
        {
            ...
            description: 'Флагманская линия для крупных производств по переработке древесного сырья. Цена от 27,9 млн ₽. Подбор, изготовление, поставка и запуск под ключ.',

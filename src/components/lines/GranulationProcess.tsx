            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-10 sm:mb-14">
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                        Как линия гранулирования перерабатывает опилки<br className="hidden sm:block" />
                        в топливные пеллеты
                    </h2>
                    <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        Линия по производству пеллет включает подготовку сырья, сушку,
                        гранулирование, охлаждение и фасовку. Ниже показано, как работает
                        комплексная линия гранулирования и какие этапы проходит сырьё
                        до готовой гранулы.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-sm text-gray-600 leading-relaxed pl-11">
                            <p className="mb-2">Линия гранулирования перерабатывает широкий спектр сырья:</p>
                            <ul className="space-y-1.5">
                                ...
                                <li>Брёвна, горбыль и кусковые отходы пиломатериалов — при условии установки в линию рубительной машины, которая измельчает их в щепу.</li>
                            ...
                            <p className="mt-3 italic text-gray-500">
                                Под конкретное сырьё подбираются состав линии, режим сушки и тип гранулятора.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-sm text-gray-600 leading-relaxed pl-11">
                            <p className="mb-2">Линия по производству пеллет обеспечивает автоматизированный процесс переработки сырья:</p>
                            <ul className="space-y-2">
                                ...
                                <li>
                                    ...
                                    Линия гранулирования обеспечивает точный контроль влажности, что напрямую

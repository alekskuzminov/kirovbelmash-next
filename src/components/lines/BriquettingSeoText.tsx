                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-red-50 rounded-xl py-6 px-6 sm:px-8 border border-red-100 relative">
                            ...
                            <p className="text-base sm:text-lg text-gray-800 italic font-medium leading-relaxed pl-4">
                                Каждая линия брикетирования КировБелМаш — автоматизированный
                                производственный комплекс от подачи сырья до выхода упакованных брикетов.
                                Оператору остаётся контролировать загрузку и параметры прессования.
                                Наши линии работают от Вологодской области до Красноярского края —
                                и каждая вышла на проектную мощность в первый месяц после пусконаладки.
                            </p>
                        </div>

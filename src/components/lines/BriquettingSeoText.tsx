            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
                        Купить оборудование для производства топливных брикетов от производителя
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                            КировБелМаш — российский производитель оборудования для изготовления
                            топливных брикетов с собственной производственной площадкой более 5 000 м²
                            в Кировской области. Мы проектируем и изготавливаем линии брикетирования
                            полного цикла: от приёмки сырья до упаковки готовых брикетов Pini&nbsp;&&nbsp;Kay.
                            Покупая напрямую у производителя, вы получаете заводскую цену без
                            посреднических наценок и единого ответственного подрядчика на весь проект.
                        </p>
                        ...
                        <div className="bg-red-50 rounded-xl py-6 px-6 sm:px-8 border border-red-100 relative">
                            ...
                            <p className="text-base sm:text-lg text-gray-800 italic font-medium leading-relaxed pl-4">
                                Главное преимущество брикетирования — минимальные требования
                                к сырью. Опилки, стружка, горбыль, лузга — всё, что раньше
                                уходило в отвал, превращается в товарный продукт. Прессы
                                Pini&nbsp;&&nbsp;Kay работают без связующих добавок: брикет
                                держит форму за счёт лигнина, который выделяется при нагреве
                                и давлении. Два оператора на смену — и линия работает.
                            </p>
                        </div>
                        ...
                        <div>
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                                ...
                                В составе каждой линии изготовления брикетов
                            </h3>
                            ...
                            <p className="text-sm sm:text-base text-gray-600 mt-4 leading-relaxed">
                                Оборудование для брикетов из опилок, щепы, горбыля и других
                        ...
                        <div className="border border-gray-200 rounded-xl p-5 sm:p-6 bg-gray-50">
                            ...
                            <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">
                                Стоимость линии производства топливных брикетов из опилок зависит от
                                производительности: от 10,5 млн ₽ за комплект на 500 кг/ч до 33 млн ₽
                                на 2000 кг/ч. В цену включено всё оборудование — от рубительной машины
                                до системы автоматики. Монтаж и пусконаладка рассчитываются отдельно
                                исходя из удалённости объекта.
                            </p>
                            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                                Купить станок для производства брикетов или полную линию можно напрямую
                                с завода: без посредников, с договором, актом и гарантийным талоном.
                                Срок изготовления — 6–8 недель с момента подписания договора.
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-28 bg-[#1a1f2c] rounded-2xl p-6 sm:p-8 text-white shadow-xl">
                            ...
                            <ContactModalButton
                                message="Подбор линии брикетирования"

...
const faqs: FAQItem[] = [
    ...
    },
    {
        ...
        answer: 'Линии работают с опилками, стружкой, щепой, лузгой подсолнечника, соломой и другими древесными и сельскохозяйственными отходами. Крупнокусковое сырьё — горбыль, рейки, кусковые отходы пиломатериалов — тоже подходит, но для него в состав линии опционально добавляется рубительная машина, которая измельчает его в щепу. Для брикетирования и гранулирования рабочая влажность сырья должна быть в диапазоне 8–12%. Если исходная влажность выше 12%, в составе линии нужен сушильный блок.',
    },
    {

...
const faqs: FAQItem[] = [
    ...
    },
    {
        ...
        answer: 'Линии работают с опилками, стружкой, щепой, горбылём, лузгой подсолнечника, соломой и другими древесными и сельскохозяйственными отходами. Для брикетирования и гранулирования рабочая влажность сырья должна быть в диапазоне 8–12%. Если исходная влажность выше 12%, в составе линии нужен сушильный блок.',
    },
    {

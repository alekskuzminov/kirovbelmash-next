            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
                        Линии гранулирования для производства пеллет от производителя
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                            Линия по производству пеллет — это не один гранулятор, а полный
                            технологический комплекс: подготовка сырья, сушка, гранулирование,
                            охлаждение, фасовка и автоматика. КировБелМаш проектирует и
                            изготавливает такие линии гранулирования на собственной
                            производственной площадке в Кировской области. Покупая напрямую
                            у производителя, вы получаете заводскую цену без посредников
                            и одного ответственного подрядчика на весь проект.
                        </p>
                        ...
                        <div className="bg-red-50 rounded-xl py-6 px-6 sm:px-8 border border-red-100 relative">
                            ...
                            <p className="text-base sm:text-lg text-gray-800 italic font-medium leading-relaxed pl-4">
                                Главное в линии гранулирования — не паспортная мощность
                                гранулятора, а стабильная работа всей цепочки. Если сырьё
                                по фракции и влажности подготовлено правильно, линия даёт
                                плотную гранулу, которую можно фасовать без лишней пыли,
                                боя и простоев. Поэтому под производство пеллет всегда
                                подбирают не отдельный станок, а весь комплекс.
                            </p>
                        </div>
                        ...
                        <div>
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                                ...
                                Что входит в линию гранулирования для производства пеллет
                            </h3>
                            ...
                            <p className="text-sm sm:text-base text-gray-600 mt-4 leading-relaxed">
                                В результате вы получаете не отдельный пеллетный станок, а
                                увязанную линию гранулирования, где каждый узел подобран по
                                производительности, типу сырья и требованиям к готовой грануле.
                            </p>
                        </div>
                        ...
                        <div className="border border-red-100 rounded-xl p-5 sm:p-6 bg-red-50/60">
                            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
                                ...
                                Нужны отдельные станки, а не комплексная линия?
                            </h3>
                            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                                Если вы модернизируете действующий цех, можно купить не только
                                комплексную линию, но и отдельные станки для производства пеллет:
                                например,{' '}
                                <Link href="/oborudovanie/granuljator-ogm-1-5" className="text-red-600 underline underline-offset-2 hover:text-red-700 font-medium">
                                    гранулятор ОГМ-1,5
                                </Link>{' '}
                                или весь раздел{' '}
                                <Link href="/oborudovanie/oborudovanie-dlja-proizvodstva-granul" className="text-red-600 underline underline-offset-2 hover:text-red-700 font-medium">
                                    станков для производства пеллет
                                </Link>.
                                Если же вы запускаете производство с нуля, выгоднее комплексная
                                линия гранулирования под ключ: она сразу учитывает сушку,
                                охлаждение, фасовку и автоматику.
                            </p>
                        </div>
                        ...
                        <div className="border border-gray-200 rounded-xl p-5 sm:p-6 bg-gray-50">
                            ...
                            <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">
                                Стоимость линии гранулирования и комплекта оборудования для
                                производства пеллет зависит от производительности: от 10,6 млн ₽
                                за комплект на 500 кг/ч до 28,6 млн ₽ на 2000 кг/ч.
                                В цену включено всё основное оборудование — от рубительной
                                машины до гранулятора и колонны охлаждения. Монтаж и
                                пусконаладка рассчитываются отдельно исходя из удалённости объекта.
                            </p>
                            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                                Купить готовую линию гранулирования или отдельные станки можно
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-28 bg-[#1a1f2c] rounded-2xl p-6 sm:p-8 text-white shadow-xl">
                            ...
                            <h3 className="text-lg font-bold mb-2">
                                Подберём линию или отдельные станки
                            </h3>
                            <p className="text-sm text-gray-400 mb-5 leading-relaxed">
                                Расскажите о задаче — рассчитаем стоимость, подберём
                                состав линии и подготовим коммерческое предложение.
                            </p>
                            <ContactModalButton
                                message="Подбор линии и станков для гранулирования"

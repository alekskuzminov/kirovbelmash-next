...
const KP_NAV = [
    { href: '/admin/kp', label: 'Шаблоны', icon: 'ri-file-text-line' },
];
        ...
        <>
            <aside className="flex h-screen w-56 flex-col bg-gray-900 text-gray-300">
                ...
                <nav className="flex-1 overflow-y-auto py-3">
                    ...
                    <p className="px-5 pt-4 pb-1 text-xs font-medium text-gray-500 uppercase tracking-wider">КП</p>

                    {KP_NAV.map(({ href, label, icon }) => {
                        const active = pathname.startsWith(href);
                        return (
                            <Link
                                key={href}

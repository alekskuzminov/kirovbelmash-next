...
export const metadata: Metadata = {
    ...
    description: 'Оборудование и линии брикетирования для производства топливных брикетов из опилок и другого древесного сырья: проектирование, изготовление, поставка и запуск',
